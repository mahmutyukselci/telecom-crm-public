...
public class SubscriptionService {
    ...
    public SubscriptionResponse createSubscription(SubscriptionRequest request) {
        ...
        // 3. Retrieve the generated subscription ID set in the delegate (SaveSubscriptionDelegate)
        ...
        if (historicVariable == null) {
            throw new RuntimeException("Workflow failed or subscriptionId was not generated in the workflow.");
        }
        ...
        Subscription savedSubscription = subscriptionRepository.findById(generatedSubscriptionId)
                .orElseThrow(() -> new RuntimeException("Subscription not found after workflow execution"));
        ...
        // 5. Save event to Outbox table within the same DB transaction (Dual-Write prevention)
